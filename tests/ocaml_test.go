...
func TestOcamlExecution(t *testing.T) {
	cases := []struct {
		name               string
	...
	}{
		{
			...
			req: types.RunRequest{
				Language: "ocaml",
				Source:   "let () = print_endline \"Hello OCaml\"",
				Tests: []types.TestCase{
					{
						Stdin:          "",
						ExpectedStdout: "Hello OCaml\n",
					},
				},
			},
		...
		},
		{
			...
			req: types.RunRequest{
				Language: "ocaml",
				Source:   "let () = print_endline \"Hello OCaml\" syntax_error_here", // Intentional syntax error
				Tests: []types.TestCase{
					{
						Stdin:          "",
						ExpectedStdout: "",
